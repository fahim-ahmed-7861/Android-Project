...
public class SchoolClg extends AppCompatActivity {
    ...
    Button button;
    int[] picture ={R.drawable.sc1,R.drawable.sc2,R.drawable.sc3,R.drawable.sc4,R.drawable.sc5,

            R.drawable.sc6 , R.drawable.sc7,R.drawable.sc8,R.drawable.sc9,R.drawable.sc10};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_school_clg);

        this.setTitle(" School College");

        listView = findViewById(R.id.listviewscl);

        book = getResources().getStringArray(R.array.scbook);


        price = getResources().getStringArray(R.array.scprice);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(item.getItemId()==R.id.logout)
        {
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(SchoolClg.this);
