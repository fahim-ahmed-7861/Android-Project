...
public class IslamiBook extends AppCompatActivity {
    ...
    Button button;
    int[] picture1 ={R.drawable.islam1,R.drawable.islam2,R.drawable.islam3,R.drawable.islam4,R.drawable.islam5,

            R.drawable.islam6 , R.drawable.islam7,R.drawable.islam8,R.drawable.islam9,R.drawable.islam10};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_islami_book);
        listView1 = findViewById(R.id.listviewislamic);

        this.setTitle("      Islamic");

        book1 = getResources().getStringArray(R.array.islambook);


        price1 = getResources().getStringArray(R.array.islamprice);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(item.getItemId()==R.id.logout)
        {
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(IslamiBook.this);
