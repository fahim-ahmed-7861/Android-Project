...
public class Liberation extends AppCompatActivity {
    ...
    Button button;
    int[] picture ={R.drawable.libaration1,R.drawable.libaration2,R.drawable.libaration3,R.drawable.libaration4,R.drawable.libaration5,

            R.drawable.libaration6 , R.drawable.libaration7,R.drawable.libaration8,R.drawable.libaration9,R.drawable.libaration10};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_liberation);

        this.setTitle(" Liberation war");

       // this.setTitle("      মুক্তিযুদ্ধ");

        listView = findViewById(R.id.listviewliberation);

        book = getResources().getStringArray(R.array.libarationbook);


        price = getResources().getStringArray(R.array.libarationprice);
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            else if(item.getItemId()==R.id.logout)
            {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(Liberation.this);
